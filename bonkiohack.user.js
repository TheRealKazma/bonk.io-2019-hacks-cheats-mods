// ==UserScript==
// @name         Bonk.io Jump HACK - Bonkio Hacks - Best Bonk Cheat 2019
// @description  Bonkio Mods Features: Jump Hack, Faster Movement, Auto Jump, Free Skins, FPS, Adblock
// @namespace    iomods.org
// @author       iomods.org
// @version      1.0
// @require      http://code.jquery.com/jquery-3.3.1.min.js
// @updateURL    https://iomods.org/mods/bonkio.user.js
// @downloadURL  https://iomods.org/mods/bonkio.user.js
// @match        *://bonk.io/*
// @match        *iogames.space/*
// @match        *titotu.io/*
// @match        *io-games.io/*
...
//degisenkisimlar
$('#templatemo_menu').html('<div style="'+this.settings.fpsstyle+'" id="fps" class="fps"></div>');
$('#templatemo_main').prepend('<div style="'+this.settings.formstyle+'"><div class="option1"></div></div></br>');
$('#gamethumbcontainer').html('<div class="list1"></div>');
//general
